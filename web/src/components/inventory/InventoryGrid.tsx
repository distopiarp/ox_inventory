      ...
      <div className="inventory-grid-wrapper col-span-3" style={{ pointerEvents: isBusy ? 'none' : 'auto' }}>
        <div className={`flex items-center ${inventory.label ? 'justify-between' : 'justify-end'}`}>
          {(inventory.type && inventory.label) && (
            <div className='pl-2 pr-4 py-2 rounded-md text-white font-semibold text-sm text-gray-300 inline-flex items-center space-x-3'>
              <div className='p-1.5 rounded-md bg-distopia-glow bar-icon'>
                {inventoryIcon}
              </div>
          ...
          <div className="inline-flex items-center space-x-4 pl-2 pr-4 py-2 text-white rounded-md float-right">
            <div className='p-1.5 rounded-md bg-distopia-glow'>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-800" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="#fff" fill="none" strokeLinecap="round" strokeLinejoin="round">
